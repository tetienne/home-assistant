...
OVERKIZ_UNIT_TO_HA: dict[str, str] = {
    ...
    MeasuredValueType.PARTS_PER_BILLION: UnitOfConcentrationParts.PER_BILLION,
    MeasuredValueType.PARTS_PER_MILLION: UnitOfConcentrationParts.PER_MILLION,
    MeasuredValueType.PARTS_PER_QUADRILLION: UnitOfConcentrationParts.PER_QUADRILLON,
    MeasuredValueType.PARTS_PER_TRILLION: UnitOfConcentrationParts.PER_TRILLION,
